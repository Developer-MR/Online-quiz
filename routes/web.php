...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('tests', 'TestsController', ['except' => ['save-question']]);
    Route::get('test-detail/{id}', 'TestsController@getStartTest');
    Route::post('test-detail/save-question-result/{id}', 'TestsController@postSaveQuestionResult');
